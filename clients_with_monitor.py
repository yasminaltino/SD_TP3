...
def send_monitor_update(status):
    ...
    try:
        ...
        monitor_socket.settimeout(2)  # 2 second timeout
            ...
            if response:
                try:
                    ...
                    if response_data.get("status") == "GRANTED":
                        ...
                        # A notificação de 'DONE' é agora responsabilidade do Sync, não mais do cliente
                        # Após o Store, o cliente aguarda um pouco antes da próxima requisição
                        ...
                        # O cliente não precisa mais de um 'break' aqui, ele pode continuar a próxima iteração
                        # se a lógica for para continuar tentando
                    else:
